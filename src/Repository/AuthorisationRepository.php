...
/**
 * @extends ServiceEntityRepository<Authorisation>
 *
...
class AuthorisationRepository extends ServiceEntityRepository
{
    ...
    public function add(Authorisation $entity, bool $flush = false): void
    {
    ...
    public function remove(Authorisation $entity, bool $flush = false): void
    {
