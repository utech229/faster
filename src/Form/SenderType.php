...
{
	public function __construct(UserRepository $userRepo, BrandRepository $brandRepo, Services $src)
	{
		$this->userRepo		= $userRepo;
		$this->brandRepo	= $brandRepo;
		$this->userData		= $src->checkThisUser($src->checkPermission("SEND2"));
