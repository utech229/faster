...
class UserSecondAuthenticator extends AbstractAuthenticator
{
    ...
    {
        $message = $exception ? $exception->getMessage() : $this->translator->trans('Identifiants de connexion incorrects') /*$this->translator->trans('Missing credentials')*/;
