"use strict";
var KTUsersoperatorsList = function() {
    var t, e, n, r, o;
    return {
        init: function() {
            (e = document.querySelector("#kt_operators_table")) && (e.querySelectorAll("tbody tr").forEach((t => {
                ...
                },
                {
                    ...
                    render : function (data,type, full, meta) {
                        ...
                        <button class="btn btn-icon btn-active-light-primary w-30px h-30px deleter" 
                            data-id=`+data+` data-kt-operators-table-filter="delete_row">
            ...
            $('#kt_modal_add_operator_reload_button').on('click', function() {
                t.ajax.reload(null, false);
            }),
            document.querySelector('[data-kt-operators-table-filter="search"]').addEventListener("keyup", (function(e) {
                t.search(e.target.value).draw()
            })), e.querySelectorAll('[data-kt-operators-table-filter="delete_row"]').forEach((e => {
