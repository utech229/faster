"use strict";
var KTUsersstatussList = function() {
    var t, e, n, r, o;
    return {
        init: function() {
            (e = document.querySelector("#kt_statuss_table")) && (e.querySelectorAll("tbody tr").forEach((t => {
                ...
                },
                {
                    ...
                    render : function (data,type, full, meta) {
                        ...
                        <button class="btn btn-icon btn-active-light-primary w-30px h-30px deleter" 
                            data-id=`+data+` data-kt-statuss-table-filter="delete_row">
            ...
            document.querySelector('[data-kt-statuss-table-filter="search"]').addEventListener("keyup", (function(e) {
                t.search(e.target.value).draw()
            })), e.querySelectorAll('[data-kt-statuss-table-filter="delete_row"]').forEach((e => {
