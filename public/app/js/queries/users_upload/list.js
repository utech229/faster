            ...
            o && (o.querySelectorAll("tbody tr").forEach((e => {
                ...
                (e = $(o).DataTable({
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            var status = {
                                'basic': { 'title': 'BASIC', 'class': 'danger' },
                                'standard': { 'title': 'STANDARD', 'class': 'success' },
                                'premium': { 'title': 'PREMIUM', 'class': 'warning' },
                                'goldenx': { 'title': 'GOLDENX', 'class': 'primary' },
                            };
                            if (typeof status[data] === 'undefined') {
                                return data;
                            }
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            var status = {
                                ...
                                5 : { 'title': _Suspended, 'class': 'info' },
                                8 : { 'title': _Deleted, 'class': 'danger' },
                            };
                            if (typeof status[data] === 'undefined') {
                                return data;
                            }
